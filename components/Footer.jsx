...
export default function Footer() {
  ...
  return (
    <>
    {/* footer */}
    <footer className={`bg-[#1F1D20]  md:px-3 ${myFont.className} pt-8 pb-14 border-b border-[#d6d6d6]`}>
          ...
          <div className='absolute gap-2 py-4 px-3 flex items-center right-5 top-5 bg-[#e6e6e6] z-50 text-xl'>
    ...
    >
      <Link href="#"> <SlArrowUp/></Link>
        ...
        <section className='py-6 bg-[#1F1D20] md:px-3 cursor-pointer'>
